...
import tool.WordCount3Mapper;
import tool.WordCount3Reducer;
...
public class WordCount3 extends Configuration implements Tool {
    public static void main(String[] args) throws Exception {
        ...
        // 캐시로 로그파일을 올리고 맵리듀스 실행 전 시간
        long startTime = System.nanoTime();

        // 맵리듀스 실행
        int exitCode = ToolRunner.run(new WordCount3(), args);

        // 캐시로 로그파일을 올리고 맵리듀스 실행 완료 시간
